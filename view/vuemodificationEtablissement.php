...
<table width='80%' cellpadding='0' cellspacing='0' align='center'>
   <tr>
   <td align='center'><a href='../index.php'>Accueil ></a> <a href='ctrllisteEtablissements.php'> listeEtablissements ></a> modificationEtablissement</td>
   </tr>
</table>
<br>
<html lang="fr">
<form method='POST' action='ctrlmodificationEtablissement.php?'>
   <input type='hidden' value='validerModifEtab' name='action'>
   <table width='85%' cellspacing='0' cellpadding='0' align='center' 
   class='tabNonQuadrille'>
   
      <tr class='enTeteTabNonQuad'>
         <td colspan='3'><?=$nom?>  (<?=intval($id)?>)</td>
      </tr>
      <tr>
...
<?php if ($action=='validerModifEtab')
{
   if (nbErreurs()!=0)
   {
      afficherErreurs();
